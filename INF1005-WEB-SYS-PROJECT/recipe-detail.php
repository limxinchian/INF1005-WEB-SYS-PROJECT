...
<head>
    <?php
        ...
        $title = 'MealMate - ' . htmlspecialchars($recipe['title']);
...
<body>
    ...
    <div class="container mb-5 mt-4">
        <div class="row mb-4">
            ...
            <p class="text-muted fs-5">
                Preparation Time: <?php echo htmlspecialchars($recipe['prep_time_min']); ?> minutes 
                <span class="mx-2">|</span> 
                Cooking Time: <?php echo htmlspecialchars($recipe['cook_time_min']); ?> minutes
                </p>
        ...
        <div class="w-100 rounded overflow-hidden" style="aspect-ratio: 3/1.5;">
            <img src="<?php echo getImageLink($recipe['title'], $recipe['recipe_id'])?>" alt="<?php echo htmlspecialchars($recipe['title']); ?>" style="width:100%; height:100%; object-fit:cover;">
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm border-0 bg-white">
                    <div class="card-body">
                        <h2 class="card-title h4 mb-3 border-bottom pb-2">Ingredients</h2>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                        <div>
                                            ...
                                            <?php if (!empty($ing['allergens'])): ?>
                                                <div class="mt-1">
                                                    <span class="badge bg-danger text-white" style="font-size: 0.7em;">
    ...
    <div class="col-md-8">
                <div class="card shadow-sm border-0 bg-white">
                    <div class="card-body">
                        <h2 class="card-title h4 mb-4 border-bottom pb-2">Description | Instructions</h2>
                        
                        <?php if (!empty($recipe['description'])): ?>
                            <p class="lead mb-4" style="white-space: pre-line;">
