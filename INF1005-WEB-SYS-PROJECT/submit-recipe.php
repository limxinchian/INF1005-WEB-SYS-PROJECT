    ...
    <div class="container my-4">
        ...
        <form action="actions/recipe-submit.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.1" min="0" class="form-control" name="ingredient_amounts[]" placeholder="Amount (e.g. 100)" aria-label="Ingredient amount" required style="width: 130px;">
                                                                
                            <select class="form-select" name="ingredient_units[]" aria-label="Measurement unit" required style="width: 100px;">
